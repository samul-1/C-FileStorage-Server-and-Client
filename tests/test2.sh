...
build/client -p -f serversocket.sk -W tests/dummyFiles/bigfiles/big2,tests/dummyFiles/bigfiles/randbig
...
build/client -p -f serversocket.sk -W tests/dummyFiles/bigfiles/big4  -D tests/evicted1
...
build/client -p -f serversocket.sk -W tests/dummyFiles/bigfiles/big4  -D tests/evicted2
wait $SERVER_PID
wait $TIMER_PID
sleep 2
...
build/client -p -f serversocket.sk -W tests/dummyFiles/bigfiles/big1  -D tests/evicted3
